...
window.blink = blink
export default function blink(who, amount=0.8, duration=300, easing="cubicOut") {
	...
	participants[who].blink = new TWEEN.Tween(participants[who].movableBodyParts.face.morphTargetInfluences).to(newMorphs, duration)
